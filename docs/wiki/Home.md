...
This wiki describes the current GitLab-first MVP and the work still required. Runtime credentials and machine-specific files do not belong in this repository.

| Page | Purpose |
| --- | --- |
| [Installation](Installation.md) | Install, configure, upgrade, inspect, and remove the systemd service. |
